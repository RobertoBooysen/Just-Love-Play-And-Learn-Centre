...
<style>
    ...
    * {
    ...
    /*Styling for container box content*/
    ...
    /*Styling for container box image*/
...
<!--Activities Heading-->
<h1 style="color:#ccccff;;"><u><b>Activities</b></u></h1>

<br>
<div class="item">
    <!--Displaying Activity image-->
    <div class="featured-image">
        <img src="Images/Activity1.png" alt="Activity1">
    </div><!--(W3Schools,2023)-->
    <br>
    <!--Activity content about the daycare-->
    <div class="description">
        <div><b style="padding-right: 5%;padding-left: 5%;">Discover Our Fun-Filled Activities!</b>
            <!--(W3Schools,2023)-->
            <p style="text-align: justify; text-justify: inter-word; padding-right: 5%;padding-left: 5%;">Our pre-school
                classroom is a place where young minds blossom and discover the joy of learning.
                With a caring and experienced team, we create a nurturing environment that fosters creativity,
                curiosity,
                and social growth. At Just Love Play And Learn Centre, we believe that every child is a unique
                individual, and we strive
                to provide a stimulating atmosphere that encourages their natural talents and interests to flourish.</p>
            <!--(W3Schools,2023)-->
        </div>
        ...
        <div><p style="text-align: justify; text-justify: inter-word; padding-right: 5%;padding-left: 5%;"> Our engaging
                curriculum is thoughtfully designed to cater to the diverse needs of each child, blending
                play-based activities with structured learning. Through hands-on experiences, interactive play, and
                imaginative storytelling, we instill a love for knowledge while developing essential skills that prepare
                them for the years ahead.</p><!--(W3Schools,2021)-->
        </div>

        <br>

        <div><p style="text-align: justify; text-justify: inter-word; padding-right: 5%;padding-left: 5%;">Safety is of
                utmost importance to us. Our classroom is a secure space where children can freely explore
                and learn under the watchful eyes of our dedicated educators. We maintain a low student-to-teacher ratio
                to ensure personalized attention, creating an environment where your child can thrive with confidence.

                Beyond academics, we place significant emphasis on social and emotional development. Our little learners
                are encouraged to communicate, collaborate, and build meaningful relationships with their peers, helping
                them
                grow into well-rounded individuals with strong values.</p><!--(W3Schools,2023)-->
        </div>
    </div>
</div>
...
<div class="container">
    ...
    <div class="box">
        <div class="content">
            <img src="Images/Activity4.png" alt="Image 4">
        </div>
    </div><!--(W3Schools,2023)-->
</div>
